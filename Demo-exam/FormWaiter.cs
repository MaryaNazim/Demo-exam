...
namespace Demo_exam
{
    public partial class FormWaiter : Form
    {
        ...
        private void buttonStatusOrder_Click(object sender, EventArgs e)
        {
            //Формируем строку запроса на добавление строк
            string tmp = $"UPDATE orders SET status_waiter = ('оплачен') WHERE id_order = '" + id_selected_rows + "'";
        ...
        {
            string tmp = $"INSERT INTO orders (number_table, count, description, status_waiter) VALUES ('{Convert.ToInt32(textBox1.Text)}', '{Convert.ToInt32(textBox2.Text)}','{richTextBox1.Text}','принят')";
